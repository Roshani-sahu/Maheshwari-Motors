...
const Login = () => {
  ...
  const validateForm = () => {
    const newErrors = {};
    if (!formData.username?.trim()) newErrors.username = 'Email/Username is required';
        ...
        <div className="bg-white border border-neutral-200 rounded-lg shadow-sm">
          <div className="p-6 border-b border-neutral-200">
            <div className="flex flex-col items-center text-center">
              ...
              <h1 className="text-2xl text-neutral-900">ERP System Login</h1>
          ...
          <div className="p-6">
            <form onSubmit={handleSubmit} className="space-y-5">
              <div>
                <label className="block text-sm text-neutral-700">Email / Username</label>
                <input
                  name="username"
                  type="text"
                  required
          ...
          <div className="p-6 bg-neutral-50 border-t border-neutral-200 rounded-b-lg">
            <p className="text-xs text-center text-neutral-500">Copyright 2025 ERP Solutions Inc.</p>
          </div>
        </div>
      </div>
    </main>
